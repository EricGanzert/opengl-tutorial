...
int main()
{
    ...
    // Open a new window and create it's OpenGL context
    ...
    GLuint Texture = loadDDS("../tutorial05_textured_cube/uvtemplate.bmp");
    ...
    // 2 UV coordinates for each vertex. They were created with Blender.
    ...
    do{
        ...
        glVertexAttribPointer(
            0,          // attribute must match layout in the chader
            3,          // size
            GL_FLOAT,   // type
            GL_FALSE,   // normalized?
            0,          // stride
